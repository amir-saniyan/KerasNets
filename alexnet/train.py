...
def main():
    ...
    parser.add_argument('--batch-size', type=int, required=False, default=128, help='Size of the batches of data')
    parser.add_argument('--input-image-width', type=int, required=False, default=80, help='Input image width')
    parser.add_argument('--input-image-height', type=int, required=False, default=80, help='Input image height')
    ...
    model = alexnet.build_model(input_shape=input_shape, num_classes=num_classes, dropout_rate=dropout_rate)
